...
namespace redimel_server.Migrations
{
    ...
    [Migration("20231106181758_ChangingSomePropertiesToBeNullable")]
    partial class ChangingSomePropertiesToBeNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.AditionalPoint", b =>
                {
                    ...
                    b.Property<int>("TemporaryPoints")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Choice", b =>
                {
                    ...
                    b.Property<bool>("IsUniqueChoice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ChangeNotice")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ChoicesId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Page", b =>
                {
                    ...
                    b.Property<string>("ChangeNotices")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.User", b =>
                {
                    ...
                    b.HasOne("redimel_server.Models.Domain.Location", "Location")
                        .WithMany()
