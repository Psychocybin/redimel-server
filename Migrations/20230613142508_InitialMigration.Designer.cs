...
namespace redimel_server.Migrations
{
    ...
    [Migration("20230613142508_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Abilities", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.AditionalPoints", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Indicators", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.BattleGroup", b =>
                {
                    b.HasOne("redimel_server.Models.Domain.AditionalPoints", null)
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.GroupWest", b =>
                {
                    b.HasOne("redimel_server.Models.Domain.AditionalPoints", "AditionalPoints")
                        .WithMany()
                        .HasForeignKey("AditionalPointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.Hero", b =>
                {
                    b.HasOne("redimel_server.Models.Domain.Abilities", "Abilities")
                        .WithMany()
                    ...
                    b.HasOne("redimel_server.Models.Domain.Indicators", "Indicators")
                        .WithMany()
                        .HasForeignKey("IndicatorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("redimel_server.Models.Domain.SpecialAbilities", "SpecialAbilities")
                        .WithMany()
            ...
            modelBuilder.Entity("redimel_server.Models.Domain.NatureSkill", b =>
                {
                    b.HasOne("redimel_server.Models.Domain.SpecialAbilities", null)
