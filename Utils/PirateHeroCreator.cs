...
{
    public class PirateHeroCreator : HeroCreator
    {
        public const string NAME = "CrazyWater";
        public const HeroClass HEROCLASS = HeroClass.Pirate;
        ...
        public const int AGILITY = 10;
        public const int EVASION = 4;
        ...
        public const Boolean WATERCYCLE = true;
        ...
        public const Boolean THROWINGKNIVES = true;
        ...
        public const SpecialCombatSkillType SCSNAME = SpecialCombatSkillType.PirateSCS;
        public const int SCSLEVEL = 1;
        public const int SCSENERGY = 0;
        public const UltimateType ULTIMATENAME = UltimateType.PirateUltimate;
        public const int ULTIMATELEVEL = 1;
        public const int ULTIMATEENERGY = 6;

        public PirateHeroCreator()
        {
            this.Name = NAME;
