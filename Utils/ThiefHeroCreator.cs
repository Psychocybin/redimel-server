...
namespace redimel_server.Utils
{
    public class ThiefHeroCreator : HeroCreator
    {
        ...
        public const int EVASION = 12;
        public const int ENDURANCE = 6;
        public const Boolean KNIFE = false;
        ...
        public const WeaponType WEAPONTYPE = WeaponType.Dagger;
        ...
        public const Boolean CLIMBING = true;
        ...
        public const Boolean SNEAK = true;
        ...
        public const Boolean BREAKINGLOCKS = true;
        ...
        public const SpecialCombatSkillType SCSNAME = SpecialCombatSkillType.ThiefSCS;
        public const int SCSLEVEL = 1;
        public const int SCSENERGY = 4;
        public const UltimateType ULTIMATENAME = UltimateType.ThiefUltimate;
